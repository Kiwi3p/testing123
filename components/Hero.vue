        ...
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
              <div class="relative overflow-hidden py-1.5 px-4 leading-6">
            ...
            <div>
              ...
              >
                Top legal talent, on demand.
              </h1>
              <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
                Legal departments of all sizes — from startups to Fortune 500s —
                use Lawtrades’ tech-enabled platform to hire world-class
                flexible legal talent and scale their outside counsel work.
              </p>
